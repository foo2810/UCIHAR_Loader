...
x_train, y_train, persons_train = ucihar_ds.load_data(train=True, person_list=train_person_list)
x_test, y_test, persons_test = ucihar_ds.load_data(train=False, person_list=test_person_list)
